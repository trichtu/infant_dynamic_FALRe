...
network_data=./dynamic_volumne/dFNC_dataset/${sub}/area_timeseries.mat
save_dir=./dynamic_volumne/dFNC_dataset/${sub}
priors=./dynamic_volumne/script/eigenvector.mat
method=MOO-ICAR
matlab -nodisplay -nosplash -nodesktop -r "constrain_ICA( '${network_data}', '${save_dir}', 'dFNC_pos','${method}', '${priors}'); exit;"
